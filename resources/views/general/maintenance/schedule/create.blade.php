                ...
                <form action="{{route('maintenance.schedule.store')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            ...
                            <div class="col-md-12 mb-2" id="start-date-container">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <select class="form-control" name="schedule" id="schedule-type" required>
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <input type="date" class="form-control" name="next_maintenance" id="next-maintenance" required>
                        </div>
                        <div class="col-md-12 mt-2">
                            <button class="btn btn-primary w-100" type="submit">Save Schedule</button>
                        </div>
                    </div>
                </form>
            </div>
