@extends('layouts.vertical', ['title' => 'Distributor Update'])
        ...
        @method('PUT')
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Update Distributor Information</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="text" id="distributor-name" name="name" class="form-control" placeholder="Enter Name" value="{{ $distributor->name }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" name="email" id="seller-email" class="form-control" placeholder="Add Email" value="{{ $distributor->email }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" name="phone" id="seller-number" class="form-control" placeholder="Phone number" value="{{ $distributor->phone }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <label for="distributor-address" class="form-label">Alamat Details</label>
                                <input type="text" id="distributor-address" name="alamat" class="form-control" placeholder="Enter Address" value="{{ $distributor->address_details }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-3 bg-light mb-3 rounded">
                <div class="row justify-content-end g-2">
                    <div class="col-lg-2">
                        <button class="btn btn-outline-secondary w-100" type="submit">Save Changes</button>
                    </div>
                    <div class="col-lg-2">
                        <a href="{{ route('distributor.index') }}" class="btn btn-primary w-100">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.code === "200") {
                ...
                // Set value provinsi
                $('#provinsi').val('{{ $distributor->province }}').trigger('change');
            } else {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.code === "200") {
                        ...
                        // Set value kabupaten
                        $('#kabupaten').val('{{ $distributor->city }}');
                    } else {
